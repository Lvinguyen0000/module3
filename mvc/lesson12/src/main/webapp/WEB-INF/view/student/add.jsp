                    ...
                    <div class="card-body">
                        ...
                        <form action="<c:url value="/students/add"/>" method="post">
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <div class="form-floating mb-3 mb-md-0">
                                        <input class="form-control" id="fullName" name="fullName" type="text" placeholder="Nhập họ tên" />
                                        <label for="fullName">Họ tên</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input class="form-control" id="age" name="age" type="number" placeholder="Nhập tuổi" />
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <div class="form-floating mb-3 mb-md-0">
                                        <input class="form-control" id="username" name="userName" type="text" placeholder="Nhập tài khoản" />
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input class="form-control" id="clazzId" name="clazzId" type="text" placeholder="Nhập mã lớp" />
                            ...
                            <div class="mt-4 mb-0">
                                <div class="d-grid">
                                    <label><input type="submit" class="btn btn-primary btn-block" value="Tạo"></label>
                                </div>
                            </div>
                        </form>
                    </div>
